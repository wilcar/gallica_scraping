...
<https://github.com/hackathonBnF/hackathon2016/wiki/SERVICE-VISU-ISSUES> <https://github.com/hackathonBnF/hackathon2016/wiki/API-Gallica---Document>

## composition

La partie obligatoire de l'identifiant est constituée des éléments suivants :

1.  Le type, ou schème, d'identifiant « ark: » déclare qu'il s'agit d'un identifiant ARK.

2.   Le numéro d'autorité nommante correspondant à une organisation habilitée à attribuer des ARK.

3.  Le nom ARK est une chaîne de caractères spécifique à la ressource attribué par l'autorité nommante.

4.  Optionnellement, sont définis des qualificatifs, c'est-à-dire des suffixes permettant d'identifier des composantes ou variantes d'une ressource (par exemple /f pour folio et /highres pour haute définition).
